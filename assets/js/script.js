...
currentURL = () => new URL(
    inIframe ? /(https?:\/\/(?:[\d\w]+\.)?[\d\w\.]+(?::\d+)?)/g.exec(
        document.referrer
...
jsonToBase64 = (jsonCode, withURL = false, redirect = false) => {
    ...
    json = window.json || {
        ...
        embed: {
            ...
            description: "You can use [links](https://melonbot.io.com) or emojis :wilted_rose: 🥀\n```\nAnd also code blocks\n```",
            color: 4321431,
            timestamp: new Date().toISOString(),
            url: "https://melonbot.io",
            author: {
                name: "inthedark.org",
            ...
            fields: [
                {
                    name: "Field 1, *dore* **me**, ~~fa~~",
                    value: "Field value"
                },
                {
                    name: "Field 2",
                    value: "You can use custom emojis <a:atheist:803209616744906752> <:brofist:799976232506621962>",
                    inline: false
                },
                {
                    name: "Inline field",
